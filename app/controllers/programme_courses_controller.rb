class ProgrammeCoursesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to programme_courses_url, notice: "Programme course was successfully destroyed." }
  ...
  private
    ...
    def programme_course_params
      params.require(:programme_course).permit(:ProgrammeID, :CourseID)
    end
end
