...
class HospitalsTest < ApplicationSystemTestCase
  ...
  test "creating a Hospital" do
    ...
    fill_in "Hospital contactno", with: @hospital.hospital_contactNo
    fill_in "Hospital locatioin", with: @hospital.hospital_locatioin
    fill_in "Hospital name", with: @hospital.hospital_name
