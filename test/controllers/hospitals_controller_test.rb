...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { hospital_contactNo: @hospital.hospital_contactNo, hospital_locatioin: @hospital.hospital_locatioin, hospital_name: @hospital.hospital_name } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { hospital_contactNo: @hospital.hospital_contactNo, hospital_locatioin: @hospital.hospital_locatioin, hospital_name: @hospital.hospital_name } }
