...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { BlockEndDate: @block.BlockEndDate, BlockStartDate: @block.BlockStartDate } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { BlockEndDate: @block.BlockEndDate, BlockStartDate: @block.BlockStartDate } }
